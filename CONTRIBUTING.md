...
## Styleguides
### Commit Messages
The repository adheres by the [conventional commits specification](https://www.conventionalcommits.org/en/v1.0.0/#specification) for its commit messages and structures. Commits from contributors not following this specifications will be rejected. 
